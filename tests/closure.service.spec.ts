...
import { VerificationService } from '../app/src/modules/closure/verification.service';
...
describe('Closure services integration (PUS-146)', () => {
  ...
  beforeAll(async () => {
    ...
    const closureCacheService = {
      invalidatePermit: jest.fn().mockResolvedValue(undefined),
    } as unknown as import('../app/src/modules/closure/closure-cache.service').ClosureCacheService;
    ...
    } as unknown as import('../app/src/modules/closure/notification.service').NotificationService;
